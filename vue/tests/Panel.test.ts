...
describe('Panel', () => {
  ...
  it('supports top navigation, a SPA link adapter, icon registry, safe attributes and theme hooks', () => {
    ...
    expect(document.head.querySelector('[data-inlay-theme-style]')?.textContent).toContain('[data-contract^="inlay."]')
    expect(document.head.querySelector('[data-inlay-theme-style]')?.textContent).toContain('--media-surface: var(--inlay-surface) !important')
    expect(document.head.querySelector('[data-inlay-theme-style]')?.textContent).toContain('--media-muted-surface: var(--inlay-surface-muted) !important')
    expect(document.head.querySelector('[data-inlay-theme-style]')?.textContent).toContain('--inlay-widget-text: var(--inlay-foreground) !important')
