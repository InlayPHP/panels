...
export function GlobalSearch({ config, placement = 'header-end', linkComponent, onNavigate }: Props) {
  ...
  return <div className={`relative min-w-0 ${isSidebar ? 'w-full' : 'w-56 max-w-[min(14rem,42vw)] flex-none'}`} data-placement={placement} data-slot="global-search">
